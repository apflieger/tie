...
func TestCreateCommand(t *testing.T) {
	test.RunOnRepo(t, "FromHead", func(t *testing.T, context test.TestContext, repo *git.Repository) {
	...
	test.RunOnRepo(t, "OnOtherBranch", func(t *testing.T, context test.TestContext, repo *git.Repository) {
	...
	test.RunOnRepo(t, "LocalTipAlreadyExists", func(t *testing.T, context test.TestContext, repo *git.Repository) {
		head, _ := repo.Head()
	...
	test.RunOnRepo(t, "BaseDoesntExists", func(t *testing.T, context test.TestContext, repo *git.Repository) {
	...
	test.RunOnRepo(t, "RemoteTipAlreadyExists", func(t *testing.T, context test.TestContext, repo *git.Repository) {
		head, _ := repo.Head()
